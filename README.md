...
6. 리워드 설계 프로세스
    ...
    4. 손익 지점 검증
        ...
        3. 실행 계획
            ...
            1) 리워드 조합 설정
            - 랜덤으로 리워드 조합을 선택하여 5개의 조합을 생성합니다.

            2) 신뢰도 기반 분포 생성
            - 신뢰도(High, Mid, Low, Very Low)에 따라 소비금액과 분포 데이터를 활용하여 각 조합의 리워드 효과를 시뮬레이션합니다.

            3) 300회 시뮬레이션 실행
            - 각 조합에 대해 300회의 시뮬레이션을 실행하여 분포를 확인합니다.

            4) 결과 분석
            - 시뮬레이션 결과에서 **수익이 0 이상**이며, **수익이 0에 가까운 조합**을 추출합니다.
